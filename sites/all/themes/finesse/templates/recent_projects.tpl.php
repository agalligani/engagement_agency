<?php
// if (empty($title)) {
  $title = t('A Framework and Technology Built for Rapid Implementation and Measurable Results');
// }
?>
<!-- begin selected projects -->
<section>
  <h2><?php print $title; ?> </h2>
  <span class="more"> <a href="<?php print url('portfolio'); ?>"><?php print t('&ndash; View More on Our Framework'); ?> &raquo;</a></span>
